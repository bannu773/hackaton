  ...
  return (
    <div className="landing_page">
      ...
      <section className="page_2" ref={back.ref}>
        <div className="head_1">
          <div className="slide_1">
            <h2>CHAMPS OF COMPUTER SCIENCE</h2>
            <h4>PRESENT</h4>
            <h1>UHackathon 4.0 Meta Edition</h1>
            <div className="con_1">
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Tenetur, repudiandae! Vitae corporis magni earum deserunt.
              </p>
            </div>
      ...
      <section className="timer_sec" ref={stars.ref}>
        <div className="space_ship" ref={space_ship.ref}>
          <img src={SpaceShip} />
        </div>
      ...
      <div className="col-md-12 text-center " ref={line.ref}>
            <h3 className="animate-charcter1"> TIMELINE</h3>
        </div>
